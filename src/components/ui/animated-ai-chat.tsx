...
export function AnimatedAIChat({ onTaskSubmit, onTaskChange }: AnimatedAIChatProps) {
      ...
      <div className="w-full max-w-2xl mx-auto relative">
        ...
        >
          <div className="text-center space-y-3">
            ...
            >
              Describe any task and custom AI agents will do it for you
            </motion.p>
          </div>
